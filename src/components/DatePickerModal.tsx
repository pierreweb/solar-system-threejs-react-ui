...
function getSeasonalShortcutDate(season: SeasonalShortcutKey, year: number) {
            ...
            <div className="flex gap-2 mb-4">
              <button
                ...
                className={cn(
                  ...
                  isDark
                    ? "border-white/10 hover:border-gold-neon/50"
                    : "border-black/10 hover:border-mist-primary/50",
                )}
              >
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        currentDate.getMonth() === i
                          ? isDark
                            ? "bg-gold-neon text-black font-bold"
                            : "bg-mist-primary text-white font-bold"
                          : isDark
                            ? "hover:bg-white/5"
                            : "hover:bg-black/5",
                      )}
                    ...
                    className={cn(
                      ...
                      d === currentDate.getDate()
                        ? isDark
                          ...
                          : "bg-mist-primary text-white font-bold"
                        : isDark
                          ? "hover:bg-gold-neon/20 hover:text-gold-neon"
                          : "hover:bg-mist-primary/20 hover:text-mist-primary",
                    )}
                  >
                    {d}
                  </button>
